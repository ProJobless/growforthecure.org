...
<table width="600px" align="center">
	<tr>
		<td style="padding:10px;font-family:helvetica,arial,sans-serif;color:black;font-size:14px;line-height:140%;">
			...
			<p>Join Grow for the Cure, select your beard styles, and then shave your beard like the style that receives the most pledges. Let&apos;s see what your face could do for Lung Cancer.</p>
